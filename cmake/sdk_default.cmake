...
# This CMake module will load all Sdk CMake modules in correct order for
# default Sdk build system.
#
# Outcome:
...
# find_package(SdkBuildConfiguration
...
# find_package(SdkAppConfiguration
#   QUIET NO_POLICY_SCOPE
#   NAMES SdkApp
...
if(${CMAKE_VERSION} VERSION_EQUAL 3.22.1 OR ${CMAKE_VERSION} VERSION_EQUAL 3.22.2)
  ...
  cmake_path(GET SDK_BASE PARENT_PATH test_cmake_path)
  if(SDK_BASE STREQUAL test_cmake_path)
...
# Prepare user cache
list(APPEND sdk_cmake_modules python)
# list(APPEND sdk_cmake_modules user_cache)

# Load Sdk extensions
# list(APPEND sdk_cmake_modules extensions)
# list(APPEND sdk_cmake_modules version)

# Load basic settings
# list(APPEND sdk_cmake_modules basic_settings)

#
# Find tools
#

# list(APPEND sdk_cmake_modules west)
# list(APPEND sdk_cmake_modules ccache)

# Load default root settings
# list(APPEND sdk_cmake_modules root)
...
#
# list(APPEND sdk_cmake_modules sdk_module)

# list(APPEND sdk_cmake_modules boards)
# list(APPEND sdk_cmake_modules shields)
# list(APPEND sdk_cmake_modules snippets)
# list(APPEND sdk_cmake_modules arch)
# list(APPEND sdk_cmake_modules configuration_files)
# list(APPEND sdk_cmake_modules generated_file_directories)

# Include board specific device-tree flags before parsing.
# set(pre_dt_board "\${BOARD_DIR}/pre_dt_board.cmake" OPTIONAL)
# list(APPEND sdk_cmake_modules "\${pre_dt_board}")

# DTS should be close to kconfig because CONFIG_ variables from
# kconfig and dts should be available at the same time.
# list(APPEND sdk_cmake_modules dts)
list(APPEND sdk_cmake_modules kconfig)
# list(APPEND sdk_cmake_modules soc)

foreach(component ${SUB_COMPONENTS})
  if(NOT ${component} IN_LIST sdk_cmake_modules)
    message(FATAL_ERROR
      "Subcomponent '${component}' not default module for Sdk CMake build system.\n"
      "Please choose one or more valid components: ${sdk_cmake_modules}"
    )
  endif()
endforeach()

foreach(module IN LISTS sdk_cmake_modules)
  ...
  if(DEFINED SUB_COMPONENTS AND NOT SUB_COMPONENTS)
    # All requested Sdk CMake modules have been loaded, so let's return.
    return()
  endif()
endforeach()
