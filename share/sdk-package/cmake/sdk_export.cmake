...
# Purpose of this CMake file is to install a SdkConfig package reference in:
# Unix/Linux/MacOS: ~/.cmake/packages/Sdk
# Windows         : HKEY_CURRENT_USER
#
# Having SdkConfig package allows for find_package(Sdk) to work when ZEPHYR_BASE is not defined.
#
...
if(WIN32)
  execute_process(COMMAND ${CMAKE_COMMAND}
                  -E  write_regv
                 "HKEY_CURRENT_USER\\Software\\Kitware\\CMake\\Packages\\Sdk\;${MD5_SUM}" "${CMAKE_CURRENT_LIST_DIR}"
)
else()
  file(WRITE $ENV{HOME}/.cmake/packages/Sdk/${MD5_SUM} ${CMAKE_CURRENT_LIST_DIR})
endif()

message("Sdk (${CMAKE_CURRENT_LIST_DIR})")
message("has been added to the user package registry in:")
if(WIN32)
  message("HKEY_CURRENT_USER\\Software\\Kitware\\CMake\\Packages\\Sdk\n")
else()
  message("~/.cmake/packages/Sdk\n")
endif()
