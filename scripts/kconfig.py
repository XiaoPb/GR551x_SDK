...
def main():
    ...
    if args.sdk_base:
        os.environ['SDK_BASE'] = args.sdk_base
        os.environ['srctree'] = args.sdk_base
    ...
    if not os.path.exists(os.path.dirname(args.config_out)):
        os.makedirs(os.path.dirname(args.config_out))
    if not os.path.exists(os.path.dirname(args.header_out)):
        os.makedirs(os.path.dirname(args.header_out))
    if not os.path.exists(os.path.dirname(args.kconfig_list_out)):
        os.makedirs(os.path.dirname(args.kconfig_list_out))
...
def parse_args():
    ...
    parser.add_argument("--sdk-base",
                        help="Path to current SDK installation")
